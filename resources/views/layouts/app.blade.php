...
<head>
  ...
  <!-- Using Bootstrap 5 CSS from CDN for consistency -->
  ...
  <link href="{{ asset("tokopedia_carousel.css") }}" rel="stylesheet" />
  ...
  <div class="container">
    ...
    <div class="card-wrapper">
      ...
      <div class="card-custom">
        <img src="{{ asset('assets/homepage/img/destinasi/4.png') }}" alt="Heha Sky View" class="card-img">
      ...
      <div class="card-custom">
        <img src="{{ asset('assets/homepage/img/destinasi/3.png') }}" alt="Waduk Sermo" class="card-img">
        <div class="card-body-custom">
      ...
      <div class="card-custom">
        <img src="{{ asset('assets/homepage/img/destinasi/2.png') }}" alt="Pantai Parangritis" class="card-img">
        <div class="card-body-custom">
      ...
      <div class="card-custom">
        <img src="{{ asset('assets/homepage/img/destinasi/5.png') }}" alt="Mangunan Yogyakarta" class="card-img">
        <div class="card-body-custom">
      ...
      <div class="card-custom">
        <img src="{{ asset('assets/homepage/img/destinasi/1.png') }}" alt="Bukit Bintang" class="card-img">
        <div class="card-body-custom">
      ...
      <div class="card-custom">
        <img src="{{ asset('assets/homepage/img/destinasi/6.png') }}" alt="Merapi Park" class="card-img">
        <div class="card-body-custom">
      ...
      <div class="card-custom">
        <img src="{{ asset('assets/homepage/img/destinasi/7.png') }}" alt="Sungai Mudal" class="card-img">
        <div class="card-body-custom">
      ...
      <div class="card-custom">
        <img src="{{ asset('assets/homepage/img/destinasi/9.png') }}" alt="Candi Prambanan" class="card-img">
        <div class="card-body-custom">
      ...
      <div class="card-custom">
        <img src="{{ asset('assets/homepage/img/destinasi/8.png') }}" alt="Benteng Vredeburg" class="card-img">
        <div class="card-body-custom">
      ...
      <div class="card-custom">
        <img src="{{ asset('assets/homepage/img/destinasi/10.png') }}" alt="Malioboro" class="card-img">
        <div class="card-body-custom">
