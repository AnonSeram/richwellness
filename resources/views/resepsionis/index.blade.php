    ...
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <!-- Form Pencarian -->
                <form action="{{ route('dataReservasiResep.cari') }}" method="GET" class="mb-4">
                ...
                <!-- Form Filter Tanggal -->
                <form action="{{ route('dataReservasiResep.filter') }}" method="GET" class="mb-4">
                    <div class="row justify-content-md-center">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                            @forelse($dataReservasiResep as $row)
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group" role="group">
                                            <a href="{{ route('dataReservasiResep.edit', $row->id) }}" 
                                               class="btn btn-sm btn-info" title="Edit">
                                                <i class="mdi mdi-pencil"></i>
                                            </a>
                                            <form action="{{ route('dataReservasiResep.destroy', $row->id) }}" method="post" class="d-inline">
                                                @csrf
                                                @method('DELETE')
                    ...
                    <!-- Pagination -->
                    @if($dataReservasiResep->hasPages())
                        <div class="mt-4">
                            {{ $dataReservasiResep->links() }}
                        </div>
                    @endif
                </div>
            </div>
